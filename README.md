...
Pushing a matching tag such as `v0.1.5` packages the extension and publishes a GitHub Release automatically. The workflow refuses to release unless the tag, `manifest.json`, and `CHANGELOG.md` agree; store uploads remain manual. See [RELEASING.md](docs/RELEASING.md) for the complete checklist.
