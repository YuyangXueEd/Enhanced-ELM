...
Enhanced ELM uses the same validated `Enhanced-ELM-0.1.4.zip` package for Microsoft Edge Add-ons as for the Chrome Web Store. Edge Add-ons accepts extension ZIP packages and converts them for distribution.
...
2. Create a Microsoft Edge Add-ons extension submission and upload `Enhanced-ELM-0.1.4.zip`.
