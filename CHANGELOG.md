...
- Kept the composer bottom-pinned when an attachment produces only ELM's "selected documents" system event.

## 0.1.1 — 8 August 2026

- Added the first compact attachment dock implementation.
- Documented the attachment regression test and ELM New look compatibility boundary.
